...
#              linetype = 2) +
  ...
  ggsave("figs/EURO_0/fig2_1_max_full.png",
         width = 15,
         height = 10)  
  ...
  ggsave("figs/EURO_0/fig2_2_max_original.png",
         width = 15,
         height = 10)  
  ...
  ggsave("figs/EURO_0/fig2_3_max_alpha.png",
         width = 15,
         height = 10)  
  ...
  ggsave("figs/EURO_0/fig2_4_max_delta.png",
         width = 15,
         height = 10)  
