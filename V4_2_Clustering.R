...
# Reduced number of countries however age specific vaccination
policy_raw_age <- c("C1","C2","C3","C4","C5","C6","C7","C8","E1","E2","H1","H2","H3","H6","V_18_60_adj", "V_60_adj", "V_tot_adj")
...
ggsave("figs/EURO_2/fig2_2_max_original.png",
       width = 15,
       height = 10)  
...
ggsave("figs/EURO_2/fig2_3_max_alpha.png",
       width = 15,
       height = 10)  
...
ggsave("figs/EURO_2/fig2_4_max_delta.png",
       width = 15,
       height = 10)  
