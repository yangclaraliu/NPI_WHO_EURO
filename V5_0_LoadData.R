...
# Save RDS
saveRDS(list(s1_W = joined_mid_S1_W,
             s1_A = joined_mid_S1_A,
             s1_D = joined_mid_S1_D,
             
             s2_W = joined_mid_S2_W,
             s2_A = joined_mid_S2_A,
             s2_D = joined_mid_S2_D,
             
             s3_W = joined_mid_S3_W,
             s3_A = joined_mid_S3_A,
             s3_D = joined_mid_S3_D,
             
             s4_W = joined_mid_S4_W,
             s4_A = joined_mid_S4_A,
             s4_D = joined_mid_S4_D,
             
             stringency = stringency,
             policy_dic = policy_dic_V), 
        here("data", "joined_all_V5.RDS"))
